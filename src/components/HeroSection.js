...
const HeroSection = () => {
  ...
  // Animation variants for right navbar
  const menuVariants = {
    closed: {
  ...
  return (
    <div className="relative min-h-screen  bg-[#f6f7f7]">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            {/* Logo */}
            <Link href="/">
              <span className="currsor-pointer">
                <img src="/navLogo.png" className="md:w-30 w-22" alt="Logo" />
                {/* <img
                  src="/navLogo.png"
                  className="md:w-30 w-22"
                  alt="Logo"
                /> */}
              </span>
            </Link>
        ...
        {isContentOpen && (
          ...
          >
            <div className="flex flex-col items-center justify-center h-full p-6">
              <img src="/logoWhiteHeaven.png" className="w-[50%]" alt="Logo" />
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center justify-center h-full p-6">
          <img src="/logoWhiteHeaven.png" className="md:w-[30%] " alt="Logo" />
          <span className="text-center  w-[80%] md:w-[50%] mt-4 text-lg md:text-xl text-slate-600 opacity-80">
            White Heaven Entertainments Pvt. Ltd., a premier artist curation and
            programming company dedicated to delivering unforgettable
